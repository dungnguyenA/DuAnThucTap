<meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('clients/css/chosen.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('clients/css/lightbox.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('clients/css/pe-icon-7-stroke.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('clients/css/jquery.mCustomScrollbar.css') }}">
