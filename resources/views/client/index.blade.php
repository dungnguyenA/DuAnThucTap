...
@section('content')
    <div class="owl-carousel nav-style4 nav-center-center " data-nav="true" data-dots="false" data-loop="true"
        ...
        <div class="banner-text style4">
            <div class="image">
                <a href="#"><img src="{{ asset('clients/images/slides/11-1.jpg') }}" alt=""></a>
            </div>
        ...
        <div class="banner-text style4">
            <div class="image">
                <a href="#"><img src="{{ asset('clients/images/slides/11-2.jpg') }}" alt=""> </a>
            </div>
            <div class="content-text">
                <h4 class="subtitle">Trending</h4>
                <h3 class="title">new books</h3>
        ...
        <div class="banner-text style4">
            <div class="image">
                <a href="#"><img src="{{ asset('clients/images/slides/11-3.jpg') }}" alt=""></a>
            </div>
            <div class="content-text">
                <h4 class="subtitle">Trending</h4>
                <h3 class="title">new books</h3>
        ...
        <div class="banner-text style4">
            <div class="image">
                <a href="#"><img src="{{ asset('clients/images/slides/11-4.jpg') }}" alt=""></a>
            </div>
            <div class="content-text">
                <h4 class="subtitle">Trending</h4>
                <h3 class="title">new books</h3>
        ...
        <div class="container">
            ...
            <div class="lastest-blog owl-carousel nav-center-center nav-style7" data-nav="true" data-dots="false"
                ...
                <div class="item-blog">
                    ...
                    <div class="right">
                        <a class="banner-border" href="#"><img src="{{ asset('clients/images/blogs/04.jpg') }}"
                                alt=""></a>
                    </div>
                </div>
                <div class="item-blog">
                    ...
                    <div class="right">
                        <a class="banner-border" href="#"><img src="{{ asset('clients/images/blogs/05.jpg') }}"
                                alt=""></a>
                    </div>
                </div>
                <div class="item-blog">
